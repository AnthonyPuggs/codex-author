...
1. Copy this file to `plugins/clo-author/references/constitutional-governance.md`
...
6. Summarize the permanent articles in `AGENTS.md` if they should always shape Codex behavior
...
- [ ] File saved to `plugins/clo-author/references/constitutional-governance.md`
