...
<!--
HOW TO USE: Fill this in manually or update it during the discovery workflow.
All active Codex skills and role decisions read this file to calibrate field-specific behavior.
Delete sections that don't apply. Add sections specific to your field.
If no field is specified, default to applied economics.
-->
