...
Used by: the `review` skill, Editor, domain-referee, and methods-referee during journal-calibrated peer review
-->

## How This Works

When journal-calibrated peer review is invoked:
...
4. **Profile NOT found** → referees use the journal name + `plugins/clo-author/references/domain-profile.md` to adapt (still better than generic)
